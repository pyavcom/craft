...
class Df_RbkMoney_Model_Action_Confirm extends Df_Payment_Model_Action_Confirm {
	...
	protected function getResponseTextForError(Exception $e) {
		 ...
		 *
		 * @link http://www.rbkmoney.ru/sites/default/files/doc/rbkmoney_api.pdf
		 * страница 34
		 */
		return 'OK';
	}
	...
	/**
	 * @static
	 * @param Df_RbkMoney_ConfirmController $controller
	 * @return Df_RbkMoney_Model_Action_Confirm
	 */
	public static function i(Df_RbkMoney_ConfirmController $controller) {
