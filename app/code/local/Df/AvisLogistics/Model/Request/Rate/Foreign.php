<?php
class Df_AvisLogistics_Model_Request_Rate_Foreign extends Df_AvisLogistics_Model_Request_Rate {
	/**
	 * @override
	...
	private function getCountryId() {
		return
			...
			? 150
			: Df_AvisLogistics_Model_Request_Countries::s()->getCountryId($this->getDestinationCountry())
		;
	}
	...
	private function getCountryZone() {
		return
			$this->getRateRequest()->isDestinationMoscow()
			? 1
			: Df_AvisLogistics_Model_Request_Countries::s()->getZone($this->getDestinationCountry())
		;
	}
