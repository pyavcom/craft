<?php
/**
 * Обратите внимание, что мы перкрываем класс @see Mage_Adminhtml_Block_System_Config_Form
	...
	protected function _getAdditionalElementTypes() {
		if (!isset($this->{__METHOD__})) {
			$this->{__METHOD__} = array_merge(
				...
				, Df_Core_Model_Config::s()->getStringNodes('df/admin/config-form/element-types')
			);
		}
