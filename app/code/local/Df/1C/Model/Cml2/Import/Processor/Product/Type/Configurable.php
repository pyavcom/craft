...
class Df_1C_Model_Cml2_Import_Processor_Product_Type_Configurable
	 ...
	 */
	protected function getConfigurableProductData(Df_1C_Model_Cml2_Import_Data_Entity_Offer $offer) {
	...
	private function importParentNew() {
		Df_1C_Model_Cml2_Import_Processor_Product_Type_Configurable_New::i2($this)->process();
	}

	/** @return void */
	private function importParentUpdate() {
		Df_1C_Model_Cml2_Import_Processor_Product_Type_Configurable_Update::i2($this)->process();
	}
