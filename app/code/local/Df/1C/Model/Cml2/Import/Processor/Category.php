<?php
/**
 * @method Df_1C_Model_Cml2_Import_Data_Entity_Category|Df_1C_Model_Cml2_Import_Data_Entity getEntity()
 */
class Df_1C_Model_Cml2_Import_Processor_Category extends Df_1C_Model_Cml2_Import_Processor {
	...
	private function getParent() {
		return $this->cfg(self::P__PARENT);
	}
	...
	protected function _construct() {
		parent::_construct();
		$this->_prop(self::P__PARENT, Df_Catalog_Model_Category::_CLASS);
	}
	const _CLASS = __CLASS__;
	const P__PARENT = 'parent';
	/**
	 * @static
	 * @param Df_Catalog_Model_Category $parent
	 * @param Df_1C_Model_Cml2_Import_Data_Entity_Category $category
	 * @return Df_1C_Model_Cml2_Import_Processor_Category
	 */
	public static function i(
		Df_Catalog_Model_Category $parent, Df_1C_Model_Cml2_Import_Data_Entity_Category $category
	) {
