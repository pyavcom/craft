<?php
class Df_Directory_Model_System_Config_Source_Region_Kazakhstan extends Df_Core_Model_Abstract {
	/** @return string[][] */
	...
	private function getAsOptionArray() {
		if (!isset($this->{__METHOD__})) {
			...
			$regions = df_h()->directory()->country()->getKazakhstan()->getRegionCollection();
			$regions->setFlag(
