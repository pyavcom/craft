...
class Df_Localization_Model_Onetime_Processor_Collection extends Df_Varien_Data_Collection_Singleton {
	...
	protected function loadInternal() {
		...
		$configNodes = Mage::getConfig()->getNode('rm/design-theme-processors')->asArray();
		foreach ($configNodes as $processorId => $processorData) {
			...
			$className = df_a($processorData, 'class', Df_Localization_Model_Onetime_Processor::_CLASS);
