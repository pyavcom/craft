<?php
class Df_Localization_Model_Onetime_Dictionary_Rule_Conditions_Attribute
	extends Df_Localization_Model_Onetime_Dictionary_Rule_Conditions_Abstract {
	/**
	 * @override
	 * @return string
	 */
	protected function getEntityClass() {return Df_Catalog_Model_Resource_Eav_Attribute::_CLASS;}
