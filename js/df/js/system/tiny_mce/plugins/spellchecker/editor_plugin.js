(function() {
	...
	tinymce.create('tinymce.plugins.SpellcheckerPlugin', {
		...
		init : function(ed, url) {
			...
			ed.addCommand ('mceActiveSpellCheck', function() {
				if (!t.active) {
					t._sendRPC (
						'checkWords'
						,
						[t.selectedLang, t._getWords()]
						,
						function (r) {
							t._removeWords (false);
							if (t._menu) {
								t._menu.hideMenu();
							}
							if (0 < r.length) {
			...
			ed.onContextMenu.addToTop (t._showMenu, t);
		...
		_showMenu : function(ed, e) {
			var wordSpan = e.target;
			var dom = ed.dom;
			if (dom.hasClass(wordSpan, 'mceItemHiddenSpellWord')) {
				tinymce.dom.Event.cancel(e);
			}

			var t = this, ed = t.editor, m = t._menu, p1, vp = dom.getViewPort(ed.getWin());
