...
interface Df_Core_Const {
	...
	const CONTENT_TYPE__FORM_URL_ENCODED__UTF_8 = 'application/x-www-form-urlencoded; charset=UTF-8';
	const CONTENT_TYPE__OCTET_STREAM = 'application/octet-stream';
	const CONTENT_TYPE__TEXT__UTF_8 = 'text/plain; charset=UTF-8';
	const CONTENT_TYPE__TEXT__WINDOWS_1251 = 'text/plain; charset=windows-1251';
	const CONTENT_TYPE__XML__UTF_8 = 'application/xml; charset=utf-8';
	const CONTENT_TYPE__XML__WINDOWS_1251 = 'application/xml; charset=windows-1251';
