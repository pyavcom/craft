<?php
class Df_1C_Model_Cml2_Import_Data_Entity_AttributeValue_ProcurementDate
	extends Df_1C_Model_Cml2_Import_Data_Entity_AttributeValue_OfferPart {
	/**
	 * @override
	 * @return Df_Varien_Simplexml_Element
	 */
	public function getSimpleXmlElement() {return $this->getRequisiteDDValue()->e();}
	...
	protected function getAttributeTemplate() {
		return new Df_1C_Model_Cml2_Import_Data_Entity_Attribute_Date();
	}
	...
	/** @return Df_1C_Model_Cml2_Import_Data_Entity_RequisiteValue|null */
	 ...
	 * @return Df_1C_Model_Cml2_Import_Data_Entity_AttributeValue_ProcurementDate
	 */
