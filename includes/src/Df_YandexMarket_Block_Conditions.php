 ...
 */
class Df_YandexMarket_Block_Conditions extends Df_Adminhtml_Block_System_Config_Form_Field {
	/**
	 * @override
	...
	protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element) {
		return df_concat(
		   Df_YandexMarket_Model_Field_Conditions::i($element, $this)->getHtml()
