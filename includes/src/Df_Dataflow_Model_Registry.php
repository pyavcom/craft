...
class Df_Dataflow_Model_Registry extends Df_Core_Model_Abstract {
	...
	public function cmsBlocks() {return Df_Dataflow_Model_Registry_Collection_Cms_Blocks::s();}

	/** @return Df_Dataflow_Model_Registry_Collection_Cms_Pages */
	public function cmsPages() {return Df_Dataflow_Model_Registry_Collection_Cms_Pages::s();}
