<?php
class Df_Cms_Model_Setup_2_0_0 extends Df_Core_Model_Setup {
	/**
	 * @override
	 * @return void
	 * @throws Exception
	...
	public function process() {
		/** @var string $t_ADMIN_USER */
		$t_ADMIN_USER = rm_table('admin/user');
		/** @var string $t_HIERARCHY_LOCK */
		$t_HIERARCHY_LOCK = rm_table('df_cms/hierarchy_lock');
		/** @var string $t_HIERARCHY_METADATA */
		$t_HIERARCHY_METADATA = rm_table('df_cms/hierarchy_metadata');
		/** @var string $t_HIERARCHY_NODE */
		$t_HIERARCHY_NODE = rm_table('df_cms/hierarchy_node');
		/** @var string $t_INCREMENT */
		$t_INCREMENT = rm_table('df_cms/increment');
		/** @var string $t_PAGE */
		$t_PAGE = rm_table('cms/page');
		/** @var string $t_PAGE_REVISION */
		$t_PAGE_REVISION = rm_table('df_cms/page_revision');
		/** @var string $t_PAGE_VERSION */
		$t_PAGE_VERSION = rm_table('df_cms/page_version');
		$this->getSetup()->run("
	 ...
	 * @return Df_Cms_Model_Setup_2_0_0
	 */
