...
class Df_Shipping_Model_Rate_Request extends Mage_Shipping_Model_Rate_Request {
	...
	public function getDeclaredValueInHryvnias() {
		if (!isset($this->{__METHOD__})) {
			$this->{__METHOD__} = rm_currency()->convertFromBaseToHryvnias($this->getDeclaredValue());
		}
		return $this->{__METHOD__};
	}
	...
	public function getDeclaredValueInRoubles() {
		if (!isset($this->{__METHOD__})) {
			$this->{__METHOD__} = rm_currency()->convertFromBaseToRoubles($this->getDeclaredValue());
		}
		return $this->{__METHOD__};
	}
	...
	public function getDeclaredValueInTenge() {
		if (!isset($this->{__METHOD__})) {
			$this->{__METHOD__} = rm_currency()->convertFromBaseToTenge($this->getDeclaredValue());
		}
		return $this->{__METHOD__};
	}
