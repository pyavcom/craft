...
class Df_Catalog_Model_Convert_Parser_Product extends Mage_Catalog_Model_Convert_Parser_Product {
	...
	{
		// Используем наши улучшения экспорта только для товаров,// которые экспорта из лицензированных магазинов
	...
	private function getImageFields() {
		...
		$result =
				 ...
				 * присутствует в том числе и в Magento 1.4.0.1, * так что, вероятно, условное ветвление можно убрать.
				 */
