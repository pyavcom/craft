...
class Mage_Page_Block_Html_Pager extends Mage_Core_Block_Template
{
    ...
    public function getFirstPage2Url()
    {
        return $this->getPage2Url(1);
    }

    public function getPreviousPage2Url()
    {
        return $this->getPage2Url($this->getCollection()->getCurPage(-1));
    }

    public function getNextPage2Url()
    {
        return $this->getPage2Url($this->getCollection()->getCurPage(+1));
    }

    public function getLastPage2Url()
    {
        return $this->getPage2Url($this->getCollection()->getLastPageNumber());
    }

    public function getPage2Url($page)
    {
        return $this->getPage2rUrl(array($this->getPageVarName()=>$page));
    }

    public function getLimit2Url($limit)
    {
        return $this->getPager2Url(array($this->getLimitVarName()=>$limit));
    }

    public function getPage2rUrl($params=array())
    {
        $urlParams = array();
        $urlParams['_current']  = true;
        $urlParams['_escape']   = true;
